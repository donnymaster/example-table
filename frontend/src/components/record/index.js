...
class Record extends React.Component{
   ...
   render(){
       const { first_name ,last_name, 
               ...
               salary, weight, isSelect, id} = this.props.data;

       const { idx, deleteRecord, setSelect } = this.props; 
    return(
        <s.StyledTr>
            <td>
                <Input click={() => setSelect(id)} isChecked={isSelect} />
            </td>
            <td>
                {idx + 1}
            </td>
...
function EditBtn(props){
    ...
    return (
        <s.StylesPathEdit xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
